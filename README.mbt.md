...
```text
moon add yyyt0807/moonmvt@0.1.1
```
...
filtering, package architecture, security policy, independent interoperability,
quantitative acceptance thresholds, and explicit non-goals.
